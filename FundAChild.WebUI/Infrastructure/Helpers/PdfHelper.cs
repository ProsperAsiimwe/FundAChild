...
namespace FundAChild.WebUI.Infrastructure.Helpers
{
    ...
    public class PdfHelper
    {
        ...
        //    try {
        //        string docName = String.Format(@"FundAChild_Sales_{0}.pdf", UgandaDateTime.DateNow().Date.ToString("ddMMMyyyy"));
        //        docName = FileService.RemoveIllegalCharacters(docName, true);

        //        string destinationFolder = @"~/App_Data";

        //        //string logo = HttpContext.Current.Server.MapPath("~/Content/Imgs/FundAChild_logo.png");
        ...
        //        doc.Add(ParsePageHeading("FundAChild Periodical Sales Report"));
